				...
				<div class="modal-content">
					<form action="editBookProcess.jsp" method="post">
						...
						ResultSet resultset = statement
								.executeQuery("select * from books where book_number='" + request.getParameter("bookId") + "'");
						...
						<div class="modal-body">
							...
							<div class="form-group">
								<label>Total Pages</label> <input type="text"
									class="form-control" value="<%=resultset.getString(4)%>"
									name="totalPages">
								</textarea>
							</div>
							<div class="form-group">
						...
						<div class="modal-footer">
							...
							<input type="button" class="btn btn-default" data-dismiss="modal"
								value="Cancel"> <a href="index.jsp">Go Main Page</a>
						</div>
					</form>
				</div>
			</div>
