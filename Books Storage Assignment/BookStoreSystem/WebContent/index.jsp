	...
	<div class="container">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2>Book Store System</h2>
					</div>
					<div class="col-sm-6">
						<a href="#addBookModal" class="btn btn-success"
			...
			<table class="table table-striped table-hover">
				...
				<tbody>
					<tr>
						...
						<td><a
							href="editBook.jsp?bookId=<%=resultset.getInt(1)%>"
							class="edit" data-toggle="modal"><i class="material-icons"
								data-toggle="tooltip" title="Edit">&#xE254;</i></a> <a
							href="deleteBook.jsp?bookId=<%=resultset.getInt(1)%>"
					...
					<div class="modal-body">
						<div class="form-group">
							...
							<label>Book Id</label> <input type="text" name="bookId"
								class="form-control" value="<%=bookId%>" readonly>
						</div>
						<div class="form-group">
							<label>Book Name (Title)</label> <input type="text"
						...
						<div class="form-group">
							<label>Book Pages</label> <input type="text" class="form-control"
								name="bpages" required>
							</textarea>
						</div>
						<div class="form-group">
							<label>Book Price</label> <input type="text" name="bprice"
								class="form-control" required>
						</div>
					</div>
